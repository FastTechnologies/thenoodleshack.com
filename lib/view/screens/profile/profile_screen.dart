                                ...
                                child: Stack(
                                  clipBehavior: Clip.none, children: [
                                    ClipRRect(
                                      ...
                                      child: file != null ? Image.file(file, width: 80, height: 80,fit: BoxFit.cover, ) : data != null
                                          ? Image.network(data.path, width: 80, height: 80, fit: BoxFit.cover,)
                  ...
                  child: CustomButton(
                    ...
                    onTap: () async {
                      ...
                      if (profileProvider.userInfoModel.fName == _firstName &&
                        ...
                        updateUserInfoModel.phone = AppConstants.country_code+_phoneNumber.replaceAll(RegExp('[()\\-\\s]'), '') ?? '';
