...
class AddNewAddressScreen extends StatefulWidget {
  ...
  AddNewAddressScreen({this.isEnableUpdate = false, this.address, this.fromCheckout = false,this.isFromCart=false,this.amount=0.0});
...
print('===sucess');
                      ...
                      locationProvider.addAddress(addressModel, context).then((value) {
                        if (value.isSuccess) {
                          ...
                          Navigator.pushReplacementNamed(context, Routes.getCheckoutRoute(
                            widget.amount, 'cart', Provider.of<OrderProvider>(context, listen: false).orderType,
                    ...
                    child: Center(
                        child: Container(
                          ...
                          child: Text(
                            'Adjust pin',
                            style:
                            Theme.of(context).textTheme.headline2.copyWith(color: ColorResources.getGreyBunkerColor(context), fontSize: Dimensions.FONT_SIZE_SMALL,fontWeight: FontWeight.w500),
                          ),
                        )),
                  ),
                ),
                  ...
                  child: Container(
                    ...
                    child: Builder(
                        builder: (context) {
                          ...
                          return Row(children: [
                            Expanded(child: Text(
                                locationProvider.pickAddress==null||locationProvider.pickAddress=='' ?locationProvider.address==''||locationProvider.address==''?'Enter address Manually':locationProvider.address:locationProvider.pickAddress
