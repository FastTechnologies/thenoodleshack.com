      ...
      child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          CircleAvatar(
            ...
            child: Icon(Icons.contact_support, size: 50,color: Colors.white,),
          ),
           ...
           Row(children: [
            ...
            Expanded(child: InkWell(
              onTap: () {
                ...
                Provider.of<PaymentProvider>(context, listen: false).removeCard(paymentCardModel.paymentId, context).then((value) {
                  Navigator.pop(context);
                  Navigator.pop(context);
                });
              },
