    ...
    return Scaffold(
      ...
      floatingActionButton: _isLoggedIn ? Padding(
        ...
        child: !ResponsiveHelper.isDesktop(context) ? FloatingActionButton(
          ...
          onPressed: () =>  Navigator.pushNamed(context, Routes.getAddAddressRoute('address', 'add', AddressModel(),amount: 0.0)),
        ) : null,
      ) : null,
                      ...
                      child: ConstrainedBox(
                        ...
                        child: SizedBox(
                          ...
                          Column(
                            ...
                            children: [
                              AddButtonView(onTap: () =>  Navigator.pushNamed(context, Routes.getAddAddressRoute('address', 'add', AddressModel(),amount: 0.0))),
                              GridView.builder(
