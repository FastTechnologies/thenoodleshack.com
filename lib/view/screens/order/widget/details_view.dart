                ...
                Expanded(flex: 8, child: Row(children: [
                  Text(
                    (order.trackModel.paymentMethod != null && order.trackModel.paymentMethod.length > 0)
                        ? order.trackModel.paymentMethod=='stripe'?'Debit/Credit Card':'${order.trackModel.paymentMethod[0].toUpperCase()}${order.trackModel.paymentMethod.substring(1).replaceAll('_', ' ')}'
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(
                                child: Row(children: [
                                  Text(
                  order.orderDetails[index].price!=null?   PriceConverter.convertPrice(context, order.orderDetails[index].price - order.orderDetails[index].discountOnProduct):'Gift',
                                    style: rubikBold,
                                  ),
                                  SizedBox(width: 5),
