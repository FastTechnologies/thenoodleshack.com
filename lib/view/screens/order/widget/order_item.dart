      ...
      child: Column(children: [
        ...
        SizedBox(
          ...
          child: Row(children: [
            ...
            isRunning?  Expanded(child: orderItem.orderType != 'pos' && orderItem.orderType != 'take_away' ? CustomButton(
                ...
                if(isRunning) {
                  ...
                  orderDetails.forEach((orderDetail) {
                    ...
                    _cartList.add(CartModel(
                        ...
                        PriceConverter.convertWithDiscount(context, orderDetail.price, double.parse(orderDetail.discountOnProduct.toString()), 'amount'),
                        _variationList, double.parse(orderDetail.discountOnProduct.toString()), orderDetail.quantity,
                       double.parse( orderDetail.taxAmount.toString()), _addOnList, orderDetail.productDetails,false,false
                    )
                    );
