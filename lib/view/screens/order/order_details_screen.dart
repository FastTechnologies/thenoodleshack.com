    ...
    return Scaffold(
      ...
      body: Consumer<OrderProvider>(
        builder: (context, order, child) {
          ...
          double _total = _itemsPrice + _addOns - _discount - _extraDiscount + _tax +_tip+ deliveryCharge - (order.trackModel != null
  ...
  Widget _amountView(
    ...
    return Column(children: [
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Text('${PriceConverter.convertPrice(context, _tip)}', style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
      ]),
