                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      coupon.couponList[index].isExpired==true?null:Clipboard.setData(ClipboardData(text: coupon.couponList[index].code));
                                      coupon.couponList[index].isExpired==true?showCustomSnackBar('Coupon Expired', context, isError:  false) :showCustomSnackBar(getTranslated('coupon_code_copied', context), context, isError:  false);
                                    },
                                    child: Stack(children: [

                                      Image.asset(Images.coupon_bg, height: 100, width: 1170, fit: BoxFit.fitWidth, color: coupon.couponList[index].isExpired==true?Colors.grey:Theme.of(context).primaryColor),
                                        ...
                                        child: Row(children: [
                                          ...
                                          Expanded(
                                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                              ...
                                              SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                              coupon.couponList[index].discountType=='product'?Text(
