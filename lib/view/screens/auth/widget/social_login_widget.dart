                ...
                InkWell(
                  onTap: () async {
                    try {
                      ...
                      print(
                          '---------------google ----------- ${_googleAccount.email}');
                      print(
                          '---------------display name ----------- ${_googleAccount.displayName}');
                      print(
                          '---------------photoUrl ----------- ${_googleAccount.photoUrl}');
                      print(
                          '---------------token ----------- ${_auth.idToken}');
                      print(
                          '---------------uniq id ----------- ${_googleAccount.id}');
                          ...
                          .socialLogin(
                              SocialLoginModel(
                                  ...
                                  firstName: _googleAccount.displayName
                                      .split(' ')[0],
                                  lastName:
                                      _googleAccount.displayName.split(' ')[1],
                                  restaurantId:
                                      AppConstants.restaurantId.toString()),
                              route);
                    } catch (er) {
