                                    ...
                                    !auth.isForgotPasswordLoading ? CustomButton(
                                      ...
                                      onTap: () {
                                        if (_phoneNumberController.text.isEmpty) {
                                          ...
                                          Provider.of<AuthProvider>(context, listen: false).forgetPassword(AppConstants.country_code+_phoneNumberController.text.replaceAll(RegExp('[()\\-\\s]'), '')).then((value) {
                                            if (value.isSuccess) {
                                              Navigator.pushNamed(context, Routes.getVerifyRoute('forget-password',AppConstants.country_code+_phoneNumberController.text.replaceAll(RegExp('[()\\-\\s]'), '')));
                                            } else {
