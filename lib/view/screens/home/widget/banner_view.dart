        ...
        SizedBox(
          ...
          child: Consumer<ProductProvider>(
            builder: (context, product, child) {
              return product.dealsList != null ? product.dealsList.length > 0 ? ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Consumer<CartProvider>(
                      builder: (context, _cartProvider, child) {
                        print('==images:${Provider.of<SplashProvider>(context, listen: false).baseUrls.offerUrl}/${product.dealsList[index].image}');
                      return InkWell(
                        onTap: () {
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: FadeInImage.assetNetwork(
                              ...
                              image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.offerUrl}/${product.dealsList[index].image}',
