        ...
        return WillPopScope(
          ...
          child: Scaffold(
            appBar: ResponsiveHelper.isDesktop(context)
                ...
                : CustomAppBar(context: context, title: 'Choose Store',isBackButtonExist: true,),
                        ...
                        if(branchProvider.selectedBranchId != null) {
                          if(branchProvider.selectedBranchId != branchProvider.getBranchId() && _cartProvider.cartList.length > 0) {
                            showAnimatedDialog(
                              ...
                              title: 'You have some foods in your cart. If you change your Branch, your cart data will be reset.',
                              onTapTrue: (){
