            ...
            child: Column(
              ...
              children: [
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Row(children: [
                      ...
                      Text(
                        branchModel.branches.address != null ? branchModel.branches.address.length > 25 ? '${branchModel.branches.address.substring(0, 20)}...' : branchModel.branches.address : branchModel.branches.name,
                ...
                if(branchModel.distance != -1)  Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    Text('${(branchModel.distance*0.62137119).toStringAsFixed(0)} Miles',
