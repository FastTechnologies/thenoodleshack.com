            ...
            child: SizedBox( width: 1170,
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _isLoggedIn&&profile.userInfoModel!=null?    Row(
                      children: [
                        Text('${getGreetingMessage()}, ${profile.userInfoModel.fName}',style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL, color: ColorResources.COLOR_WHITE))
                        ,
                        SizedBox(width: 10,),
                        Image.asset(getGreetingIcons(),height: 15,),
                      ],
                    ):SizedBox(),
                    ...
                    !_isLoggedIn?  InkWell(
                      ...
                      child: Text(
            '${'Join ${AppConstants.APP_NAME} Rewards, win \$500! Be entered in a drawing to win on ${DateTime.now().month+1}/1'}',
            style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Colors.white),
          ),
                    ):SizedBox.shrink(),
                    Row(
                    ...
                    OnHover(
                      builder: (isHover){
                        return InkWell(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_DEFAULT),
                              child: Text('Orders',maxLines: 1,overflow: TextOverflow.ellipsis, style: rubikRegular.copyWith(color: isHover ? Theme.of(context).primaryColor : ColorResources.getWhiteAndBlack(context),
                                  fontSize: Dimensions.FONT_SIZE_LARGE)
                              ),
                            ));
                      },
                      ...
                      builder: (isHover){
                        ...
                        onTap: () {
                          if (_isLoggedIn) {
                            ...
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_DEFAULT),
                              child: Text('Favourites',maxLines: 1,overflow: TextOverflow.ellipsis, style: rubikRegular.copyWith(color: isHover ? Theme.of(context).primaryColor : ColorResources.getWhiteAndBlack(context),
                              fontSize: Dimensions.FONT_SIZE_LARGE)
                        ),
                            ));
                      },
                    ...
                    OnHover(
                      builder: (isHover){
                        return InkWell(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_DEFAULT),
                              child: Text('Rewards',maxLines: 1,overflow: TextOverflow.ellipsis, style: rubikRegular.copyWith(color: isHover ? Theme.of(context).primaryColor : ColorResources.getWhiteAndBlack(context),
                                  fontSize: Dimensions.FONT_SIZE_LARGE)
                              ),
                            ));
                      },
                      ...
                      builder: (isHover){
                        return InkWell(
                            onTap: () {
                              ...
                              if (_isLoggedIn) {
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ReferAndEarnScreen()));                              } else {
                                Navigator.pushNamed(
                                    context, Routes.getLoginRoute());
                              }
                            },
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_DEFAULT),
                              child: Text('Refer & Earn',maxLines: 1,overflow: TextOverflow.ellipsis, style: rubikRegular.copyWith(color: isHover ? Theme.of(context).primaryColor : ColorResources.getWhiteAndBlack(context),
                              fontSize: Dimensions.FONT_SIZE_LARGE)
                        ),
                            ));
                      },
                              ...
                              child: Center(
                                child: Text(
                                  (Provider.of<CartProvider>(context)
                                      .cartList
                                      .length+Provider.of<CartProvider>(context)
                                      .cateringList
                                      .length+
                                      Provider.of<CartProvider>(context)
                                          .happyHoursList
