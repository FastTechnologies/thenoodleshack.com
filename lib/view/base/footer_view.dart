                  ...
                  Expanded(flex: 4,
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                          Text('Newsletter', style: robotoRegular.copyWith(fontWeight: FontWeight.w600, color: ColorResources.getGreyBunkerColor(context))),
                      ...
                      OnHover(
                          builder: (hovered) {
                            return InkWell(
                                ...
                                child: Text('Coupons', style: hovered? rubikMedium.copyWith(color: Theme.of(context).primaryColor) : rubikRegular.copyWith(color: ColorResources.getGreyBunkerColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)));
                          }
                      ),
                      const SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                      OnHover(
                          builder: (hovered) {
                            return InkWell(
                                ...
                                child: Text('Wallet', style: hovered? rubikMedium.copyWith(color: Theme.of(context).primaryColor) : rubikRegular.copyWith(color: ColorResources.getGreyBunkerColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)));
                          }
                      ),
                      const SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                      OnHover(
                          builder: (hovered) {
                            return InkWell(
                                ...
                                child: Text('Orders', style: hovered? rubikMedium.copyWith(color: Theme.of(context).primaryColor) : rubikRegular.copyWith(color: ColorResources.getGreyBunkerColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)));
                          }
                      ),
