...
class NoDataScreen extends StatelessWidget {
  ...
  NoDataScreen({this.isCart = false, this.isNothing = false, this.isOrder = false, this.isFooter = true, this.isAddress = false,this.isFavourite=false});
              ...
              children: [
                Padding(
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                    ...
                    Text(
                    isFavourite?'Your Favourites will show up here':
