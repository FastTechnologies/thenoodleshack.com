...
class OrderProvider extends ChangeNotifier {
  ...
  Future<List<OrderDetailsModel>> getOrderDetails(
    ...
    if (apiResponse.response != null &&
      ...
      _orderDetails = [];
      jsonDecode(apiResponse.response.body).forEach((orderDetail) =>
  ...
  Future<void> getDeliveryManData(String orderID, BuildContext context) async {
    ...
    if (apiResponse.response != null &&
        apiResponse.response.statusCode == 200) {
      _deliveryManModel =
          DeliveryManModel.fromJson(jsonDecode(apiResponse.response.body));
  ...
  Future<ResponseModel> trackOrder(String orderID, OrderModel orderModel,
    ...
    if (orderModel == null) {
      ...
      if (apiResponse.response != null &&
          apiResponse.response.statusCode == 200) {
        _trackModel =
            OrderModel.fromJson(jsonDecode(apiResponse.response.body));
        _responseModel =
            ResponseModel(true, apiResponse.response.body.toString());
  ...
  Future<void> placeOrder(
    ...
    if (apiResponse.response != null &&
      ...
      String orderID =
          jsonDecode(apiResponse.response.body)['order_id'].toString();
  ...
  Future<bool> getDistanceInMeter(
    ...
    try {
      if (response.response.statusCode == 200 &&
        ...
        _isSuccess = true;
        _distance = DistanceModel.fromJson(jsonDecode(response.response.body))
                .rows[0]
                .elements[0]
                .distance
                .value /
